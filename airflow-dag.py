...
create_hive_database = DataprocSubmitHiveJobOperator(
    ...
    region='us-central1',
    project_id='windy-bounty-435409-t0',
    dag=dag
)
...
create_hive_table = DataprocSubmitHiveJobOperator(
    ...
    query="""
        ...
        STORED AS TEXTFILE
        LOCATION 'gs://logistic_raw/input_data/'
...
archive_processed_file = BashOperator(
    ...
    bash_command=f"gsutil -m mv gs://logistic_raw/input_data/logistics_*.csv gs://logistic_archive/",
    dag=dag
)
